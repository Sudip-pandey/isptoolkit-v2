...
class CouplerCalculatorTest {
    ...
    fun testCoupler45_55_Ratio() {
        ...
        assertEquals(1.5318, res.portAOutputDbm, 0.01)

        // 55% -> 5 + 10log10(0.55) ≈ 2.40 dBm
        assertEquals(2.4033, res.portBOutputDbm, 0.01)
    }
    ...
    fun testCoupler50_50_Ratio() {
        ...
        assertEquals(6.9897, res.portAOutputDbm, 0.01)
        assertEquals(6.9897, res.portBOutputDbm, 0.01)
    }
}
